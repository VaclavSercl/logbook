...
export const crewApi = {
  ...
  create: (data: { vessel_id: string; first_name?: string; last_name?: string; nickname?: string; name?: string; role?: string; nationality?: string; passport_number?: string; date_of_birth?: string; include_in_watches?: boolean; include_in_galley?: boolean }, token: string) =>
    apiFetch('/crew', { method: 'POST', body: data, token }),
  update: (id: string, data: Partial<{ first_name: string; last_name: string; nickname: string; name: string; role: string; nationality: string; passport_number: string; date_of_birth: string; include_in_watches: boolean; include_in_galley: boolean }>, token: string) =>
